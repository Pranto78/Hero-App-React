...
import { NavLink } from "react-router"; // ✅ keeping your import exactly as is
  ...
  return (
    <div className="navbar bg-base-100 shadow-sm">
      ...
      <div className="navbar-end">
        <a className="btn bg-gradient-to-r from-[#9F62F2] to-[#632EE3] text-white font-semibold py-2 px-6 rounded-lg shadow-md hover:opacity-90 transition mr-3">
